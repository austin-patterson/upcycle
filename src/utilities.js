...
export function sortByIdentifier(elements) {
    elements.sort( function (a, b) {
        return a.trackingIdentifier.localeCompare(b.trackingIdentifier);
    });
    return elements;
}
...
export function filterByResourceClassification(elements, resourceClassification) {
    return elements.filter(function (element) {
        return element.resourceClassifiedAs.id === resourceClassification;
    });
}
